...
export default function Post() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <Reveal delay={180}><p className="mt-4 text-sm text-black/60">By Ayaan Grover • 7 min read</p></Reveal>
  ...
  <Reveal delay={220}><div className="mt-10 aspect-[16/9] relative"><Image src="/images/15.jpg" alt="Discreet fall detection sensor installed in a resident room" fill className="object-cover" sizes="100vw" /></div></Reveal>
      ...
      <Reveal delay={540}><p className="mt-4 leading-relaxed">The best deployments feel boring: stable coverage, concise alerts, staff describing it as \"helpful background automation\" rather than a distraction. Residents and families should barely notice its presence, yet operators can surface metrics like time-to-assist improvements.</p></Reveal>
